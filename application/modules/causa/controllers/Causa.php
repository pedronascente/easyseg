...
class Causa extends MX_Controller {

    private $Dados;

    private $_location = "causa/obrigado";
    ...
    public function index() {
        $this->loadPage('causa/paginas/index');
    }
    ...
    public function obrigado(){
          $this->loadPage('causa/paginas/obrigado');           
    }
    ...
    */
    ...
    private function sendEmail($data) {      
        ...
        $this->email->subject("FORMULARIO PAGINA : CAUSA");
