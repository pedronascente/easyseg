...
class Home extends MX_Controller {
    ...
    public function politicaDePrivacidade() {
        $this->loadPage('home/paginas/politica-de-privacidade');
    }

    public function index() {
        $this->loadPage('home/paginas/index');
    }

    public function error() {
        $this->loadPage('home/paginas/error');
    }
    ...
    public function obrigado(){
         $this->loadPage('home/paginas/obrigado'); 
    }
    ...
    private function sendEmail($data) {
        ...
        <li><b>Servico :</b>'.$data['_servico'].'</li>
