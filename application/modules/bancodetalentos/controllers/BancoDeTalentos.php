...
class BancoDeTalentos extends MX_Controller {

    private $Dados;

    private $_location = "talentos/obrigado";
    ...
    public function index() {
         $this->loadPage('bancodetalentos/paginas/index');
    }

    public function save(){
        if(empty($this->input->post())){
           header('Location:'.$url.'talentos');
           exit(); 
        }
        if($this->sendEmail($this->input->post())){
            header('Location:'.$this->_location);
        }else{
            header('Location:'.$this->_location_error);
        }     
    }

    public function obrigado(){
          $this->loadPage('bancodetalentos/paginas/obrigado');           
    }
...
*/
    ...
    private function sendEmail($data) {     
        ...
        $this->email->subject("BANCO DE TALENTOS");
