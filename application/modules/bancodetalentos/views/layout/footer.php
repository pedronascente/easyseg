        ...
        <div class="container">
            <div class="row ">
                <div class="col-md-4 col-sm-8">
                    <img src="assets/img/logo-footer.png" width="140" height="" alt="Home Alarms" data-retina="true" id="logo_footer">
                ...
                <div class="col-md-3 col-md-offset-1 col-sm-4">
                    ...
                    <ul>
                        ...
                        <li><a href="#0">Produtos e Servico</a></li>
                        <li><a href="#0">Compra Online</a></li>
