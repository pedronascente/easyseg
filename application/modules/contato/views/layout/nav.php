...
<header>
                ...
                <div class="col-sm-8">
                    <ul id="top_links">
                        <li id="">Capitais e Regiões Metropolitanas   
                            ...
                            <a href="tel://55508008889696" style="color :#e94e1b "> <b><i class="icon-phone-3"></i>0800-888-9696</b></a> 
                        </li>
                    </ul>
                </div>
            </div>
    ...
    <div class="container">
        <div class="row">
            <div class="col-xs-3">
                <div id="logo">
                    <a href="<?=base_url();?>"><img src="<?=base_url('assets/img/logo.png');?>" width="180" height="" alt="Home Alarms" data-retina="true"></a>
                </div>
            </div>
            <nav class="col-xs-9">
                ...
                <div class="main-menu">
                    <div id="header_menu">
                        <img src="<?=base_url('assets/img/logo.png');?>" width="180" height="" alt="Home Alarms" data-retina="true">
                    </div>
