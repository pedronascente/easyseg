    ...
    <div class="row">
        ...
        <div class="col-md-6 col-sm-6">
            <div class="form-group">
                ...
                <input type="text"  name="_telefone" class="form-control" required="">
            </div>
        </div>
    </div>
    <div class="row">
        <div class="col-md-12">
            <div class="form-group">
                ...
                <textarea rows="5"  name="_menssagem" class="form-control" style="height:100px;"></textarea>
            </div>
        </div>
    </div>
    <div class="row">
        <div class="col-md-6">
            ...
            <input type="submit" value="Enviar" class=" button_intro  add_bottom_30" id="submit-contact"/>
        </div>
    </div>
</form> 