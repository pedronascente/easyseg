...
class Indique extends MX_Controller {

    private $Dados;

    private $_location = "indique/obrigado";
    ...
    public function index() {
        $this->loadPage('indique/paginas/index');
    }

    public function save(){
        $url=base_url();
        if($this->input->post()==null){
           header('Location:'.$url.'indique');
           exit(); 
        }
    ...
    public function obrigado(){
          $this->loadPage('indique/paginas/obrigado');           
    }
        ...
        $mensagem ='
                    ...
                    <ul>
                        ...
                        <li><b>Telefone :</b>'.$data['_telefone'].'</li>
                         <li><b>CPF :</b>'.$data['_cpf'].'</li>
                    </ul>
                    <h3>Indicacao</h3>';
        $mensagem .='<ul>
                        <li><b>Nome Amigo :</b>'.$data['_nome_amigo'].'</li>
                        <li><b>Email :</b>'.$data['_email_amigo'].'</li>
                        <li><b>Telefone :</b>'.$data['_telefone_amigo'].'</li>
                        <li><b>Serviço :</b>'.$data['_servico'].'</li>
