<form method="post" action="<?=base_url('alarme/save-negocio')?>" id="check_avail" autocomplete="off">
    <div class="row">
        ...
        <div class="col-md-12 col-sm-12">
            <div class="form-group">
                ...
                <input type="hidden" class="form-control" name="_servico" value="alarme_negocio">        
