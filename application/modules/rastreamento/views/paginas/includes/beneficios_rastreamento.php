		<div id="feat_home">
			<div class="container margin_60_25">
				<div class="row">
					<div class="col-md-6">
                        <div class="box_feat">
                            <span><img src="<?=base_url('assets/img/svg_icons/bloqueio_imediato.png');?>" alt=""></span>
					...
					<div class="col-md-6">
						<div class="box_feat">
                            <span><img src=" <?=base_url('assets/img/svg_icons/aplicativo.png');?>" alt=""></span>
                            <h3>Aplicativo</h3>
				...
				<div class="row">
                    <div class="col-md-6">
                        <div class="box_feat">
                            <span><img src="<?=base_url('assets/img/svg_icons/protec-vei.png');?>" alt=""></span>
					...
					<div class="col-md-6">
						<div class="box_feat">
                            <span><img src="<?=base_url('assets/img/svg_icons/Visualizacao_WEB.png');?>" alt=""></span>
				...
				<div class="row">
					<div class="col-md-6">
                        <div class="box_feat">
                            <span><img src="<?=base_url('assets/img/svg_icons/pronto_atendimento.png');?>" alt=""></span>
					...
					<div class="col-md-6">
						<div class="box_feat">
                            <span><img src="<?=base_url('assets/img/svg_icons/central_att24h.png');?>" alt=""></span>
